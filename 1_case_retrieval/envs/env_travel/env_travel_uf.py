...
# ====== Global Preferences ======
# The preference order for each agent, from most preferred to least preferred.
...
def compute_issue_score(option: str, pref_list: list) -> float:
    """
    Return the score based on the position of the option in the preference list:
    1st preference = 1, 2nd = 2/3, 3rd = 1/3, Unknown = 0.
    """
